...
ALREADY_BOUGHT = 'Вы уже оплатили этот пак когда-то!'
...
PAYMENT_PACK_MESSAGE = 'СООБЩЕНИЕ КОТОРОЕ НУЖНО ЗАПОЛНИТЬ 14'
...
COST_SOUND = 'Звуки из платных паков недоступны для скачивания по отдельности'
